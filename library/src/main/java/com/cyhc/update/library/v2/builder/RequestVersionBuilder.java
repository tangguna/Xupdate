...
import com.cyhc.update.library.core.http.HttpHeaders;
import com.cyhc.update.library.core.http.HttpParams;
...
public class RequestVersionBuilder {
    ...
    private com.cyhc.update.library.core.http.HttpHeaders httpHeaders;
